class simulador extends HTMLElement{
	...
	connectedCallback(){
		...
		this.Slide(
			"https://clients.hoopla.la/2022/webcomponent/01.png", 
		);

		this.Slide(
			"https://clients.hoopla.la/2022/webcomponent/02.png", 
		);

		this.Slide(
			"https://clients.hoopla.la/2022/webcomponent/03.png", 
		);

		this.Slide(
			"https://clients.hoopla.la/2022/webcomponent/04.png", 
		);

		this.Slide(
			"https://clients.hoopla.la/2022/webcomponent/05.png", 
		);

		this.Slide(
			"https://clients.hoopla.la/2022/webcomponent/06.png", 
		);
	...
	buildSlider(){
		var myHTML = '<img class="alto" src="https://clients.hoopla.la/2022/webcomponent/01.png">';
